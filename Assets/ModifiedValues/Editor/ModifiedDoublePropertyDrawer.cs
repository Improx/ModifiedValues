...
{
	[CustomPropertyDrawer(typeof(ModifiedDouble))]
	public class ModifiedDoublePropertyDrawer : PropertyDrawer
	{
		private ModifiedDouble _modValue;
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			if (_modValue is null)
			{
				...
				ModifiedDouble modValue = (ModifiedDouble)GetPropertyInstance(property, targetObject);
				if (!modValue.Init)
				{
