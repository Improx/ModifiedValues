...
[CustomPropertyDrawer(typeof(ModifiedUint))]
public class ModifiedUintPropertyDrawer : PropertyDrawer
{
	private ModifiedUint _modValue;
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		if (_modValue is null)
		{
			...
			ModifiedUint modValue = (ModifiedUint) GetPropertyInstance(property, targetObject);
			if (!modValue.Init)
			{
