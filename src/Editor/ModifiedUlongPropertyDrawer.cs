...
[CustomPropertyDrawer(typeof(ModifiedUlong))]
public class ModifiedUlongPropertyDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		if (_modValue is null)
		{
			...
			ModifiedUlong modValue = (ModifiedUlong) GetPropertyInstance(property, targetObject);
			if (!modValue.Init)
			{
